...
Revision ID: 44db2e884553
Revises: 
Create Date: 2024-12-11 17:54:53.417851
...
def upgrade() -> None:
    ...
    sa.Column('booking_confirmed', sa.Boolean(), nullable=False),
    ...
    sa.Column('price_per_day_overwrite', sa.Float(), nullable=True),
