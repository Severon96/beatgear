...
Revision ID: ece7bf94deab
Revises: 
Create Date: 2024-11-20 17:48:57.723823
...
def upgrade() -> None:
    ...
    sa.Column('child_booking_id', sa.Uuid(), nullable=True),
    sa.ForeignKeyConstraint(['booking_id'], ['bookings.id'], ),
    sa.ForeignKeyConstraint(['child_booking_id'], ['bookings.id'], )
    )
