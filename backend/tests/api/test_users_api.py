...
from tests.test_util.db_util import create_user, setup_user
...
class TestUserApi:
    ...
    def test_get_all_users_with_users(self, client, jwt):
        # when
    ...
    def test_get_user_by_id(self, client, jwt):
        # when
    ...
    def test_get_missing_user_by_id(self, client, jwt):
        # then
    ...
    def test_get_user_by_malformed_uuid(self, client, jwt):
        # then
    ...
    def test_create_user(self, client, jwt):
        # when
        user = setup_user()
    ...
    def test_create_user_with_missing_username(self, client, jwt):
        # when
        user_dict = {
            'id': uuid.uuid4(),
            'username': None,
    ...
    def test_update_user(self, client, jwt):
        # when
        user = create_user(setup_user())
    ...
    def test_update_missing_user(self, client, jwt):
        # when
        user = setup_user()
        user.username = "updated_username"
    ...
    def test_update_user_with_missing_username(self, client, jwt):
        # when
        user = create_user(setup_user())
        user_dict = user.dict()
